...
import requests
# Suppress urllib3 warnings explicitly before any use
    ...
    def run(self):
        ...
        while self.running:
            ...
            if self.frame_queue:
                ...
                txt = font.render(self.status, True, (100, 100, 110))
