...
echo "[6/6] games: Doom engine, RetroArch, uinput bridge deps"
apt-get install -y chocolate-doom freedoom retroarch retroarch-assets libretro-core-info python3-evdev || true
