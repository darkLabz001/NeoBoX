...
apt-get install -y chocolate-doom freedoom retroarch retroarch-assets libretro-core-info mednafen python3-evdev python3-pip || true
pip3 install -r "$NEO/requirements-web.txt" || true
