...
apt-get install -y chocolate-doom freedoom retroarch retroarch-assets libretro-core-info mednafen python3-evdev python3-pip python3-flask python3-flask-socketio || true
